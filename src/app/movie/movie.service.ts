...
export class MovieService {
  ...
  private api =
  'https://crudcrud.com/api/03b44a544c654a49823dbae2eb813ab2/movie';
...
/*  getMovies(): Observable<Movie[]> {
    console.log(this.httpClient.get<Movie[]>(this.api));
    ...
    getMovies(): Observable<Movie[]> {
      return this.httpClient.get<Movie[]>(this.api).pipe(
        tap((movies) => console.log('Filmes recebidos da API:', movies)) // Log dos dados recebidos
      );
    }
